...
import { getTransactionById } from "../graphql/queries/transaction.query";
...
const Transaction = () => {
  ...
  const { data, loading } = useQuery(getTransactionById, {
    variables: {
      transactionId: id,
    },
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateTransaction({
        variables: {
          input: { ...formData, transactionId: id, amount },
        },
      });
      ...
      toast.error("Couldn't update transaction, try again.");
    }
  };
